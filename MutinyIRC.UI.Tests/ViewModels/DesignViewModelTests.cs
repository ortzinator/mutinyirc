...
using MutinyIRC.UI.ViewModels.Design;
...
///
/// The fix: put all design-time view models in MutinyIRC.UI.ViewModels.Design
...
public class DesignViewModelTests
{
    ...
    public void DesignMainViewModel_IsInViewModelsDesignNamespace()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo("MutinyIRC.UI.ViewModels.Design"));
    }
