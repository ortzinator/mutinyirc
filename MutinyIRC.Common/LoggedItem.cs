...
public class LoggedItem
{
    ...
    public static string basedir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "MutinyIRC\\logs"); //hack
    ...
    public void Open()
    {
        ...
        _fileHandle = new FileStream(LogPath, FileMode.Append, FileAccess.Write, FileShare.ReadWrite);
    }
